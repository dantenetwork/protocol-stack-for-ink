...
#[derive(SpreadLayout, PackedLayout, Debug, Eq, scale::Encode, scale::Decode, Clone, Default)]
#[cfg_attr(feature = "std", derive(StorageLayout))]
...
#[derive(SpreadLayout, PackedLayout, Debug, PartialEq, Eq, scale::Encode, scale::Decode, Clone, Default)]
#[cfg_attr(feature = "std", derive(StorageLayout))]
